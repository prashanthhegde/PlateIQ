...
public class ExtentManager {
    ...
    public static ExtentReports getInstance() {
    	if (extent == null){
    		...
    		new File(System.getProperty("user.dir")+"\\ExtentReports\\"+folderName+"//screenshots").mkdirs();
    ...
    public static ExtentReports createInstance(String fileName) {
        ...
        htmlReporter.config().setReportName("Reports - Plate IQ  Automation Test Report");
